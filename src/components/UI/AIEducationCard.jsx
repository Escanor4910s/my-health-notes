    ...
    <div className="animate-fade-in glass-panel" style={{ padding: '3rem' }}>
      ...
      <header className="section-header" style={{ marginBottom: '3rem', display: 'flex', alignItems: 'center', gap: '1.25rem', borderBottom: '1px solid var(--surface-border)', paddingBottom: '1.5rem' }}>
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1rem', margin: '0.25rem 0 0 0', fontWeight: '500' }}>
            Configurez l'identité et le style clinique de votre entité.
          </p>
        </div>
      </header>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '3.5rem' }}>
        ...
        {/* SECTION 1: IDENTITE */}
        <div>
          <h4 style={{ margin: '0 0 1rem 0', fontSize: '1.15rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <ShieldCheck size={22} color="var(--primary)" /> Identité de l'assistant
          </h4>
        ...
        {/* SECTION 2: FICHIER MODELE */}
        <div>
          <h4 style={{ margin: '0 0 1rem 0', fontSize: '1.15rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <FileDigit size={22} color="var(--primary)" /> Fichier d'Apprentissage
          </h4>
        ...
        {/* SECTION 3: DIRECTIVES ET ASSIMILATION */}
        <div>
          <h4 style={{ margin: '0 0 1rem 0', fontSize: '1.15rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <Activity size={22} color="var(--primary)" /> Directives & Assimilation
          </h4>
